...
body{font:13px/1.3 'Microsoft Yahei','����';color:#000;}
...
a, a:visited {text-decoration:none;outline:none;color:black;}
	...
	#timeline {
		...
		#dates {
			...
			#dates li {
				...
				font-size: 15px;
				text-align: center;
				background: url('../images/biggerdot.png') center 30px no-repeat;
			}
				#dates a {
					line-height: 38px;
					padding-bottom: 18px;
				...
				#dates .selected {
			        font-size: 15px;
			        background: url('../images/biggestdot.jpg') center 10px no-repeat;
				}
