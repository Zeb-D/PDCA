...
<style>
    ...
    .inpt{ border:1px solid #ccc; padding:4px; background:url(style/images/o_nextprv.png) no-repeat right -18px;}
...
if(username!="请选择"){
$("#inpt").append("<div id="+username+">"+username+"<input id=\"btn1\" type=\"button\" value=\"X\" onclick=\"Del('"+username+"')\"/></div>");
			...
			<table width="550" border="2" style="margin-top: 30PX">
				...
				<td>
					<!-- <input type="text" name="url.endtime" id="time"
						...
						<input size="25" name="url.endtime" type="text" id="j_Date1" class="input">
					</td>
				</tr>
				<tr>
