...
<![endif]-->
	<!-- 包含页面的头部 -->
	<div id="first"><jsp:include page="admin-header.jsp"></jsp:include></div>
	<div> 
		<div class="am-cf admin-main">
			...
			<!-- content end -->
			<jsp:include page="department/update.jsp"></jsp:include>
			<jsp:include page="role/update.jsp"></jsp:include>
			<jsp:include page="user/update.jsp"></jsp:include>
		</div>
	</div>
	<!-- 页脚 -->
	<div><jsp:include page="admin-footer.jsp"></jsp:include></div>
